        ...
        "/gains": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Filter to the tax year the gain was realized",
                        "name": "year",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/PaginatedGains"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "Distribution": {
            ...
            "properties": {
                ...
                "category": {
                    "description": "Category is the kind of income: \"dividend\" (from a security) or \"interest\"\n(from a cash/savings balance, handled later).",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
        ...
        "Gain": {
            ...
            "properties": {
                ...
                "amount": {
                    "description": "realized gain/loss = proceeds - cost_basis",
                    "type": "number"
                },
                "asset_type": {
                    "type": "string"
                ...
                "cost_basis": {
                    "description": "includes the lot's commission and fees",
                    "type": "number"
                },
                "created_at": {
                    "type": "string"
                ...
                "proceeds": {
                    "description": "net of the sell's commission and fees",
                    "type": "number"
                },
                "quantity": {
                    "description": "shares disposed from the lot",
                    "type": "number"
                },
                "realized_date": {
                    "type": "string"
